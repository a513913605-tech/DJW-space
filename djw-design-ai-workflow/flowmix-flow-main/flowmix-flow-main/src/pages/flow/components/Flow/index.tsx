...
const rfStyle = {
  background:
    'radial-gradient(circle at 50% -18%, rgba(242, 164, 58, 0.055), transparent 28%), linear-gradient(180deg, #333638 0%, #2d3033 48%, #282b2e 100%)',
    ...
    >
        ...
        >
            <ReactFlow
                ...
                style={rfStyle}
            >
                <MiniMap nodeColor={nodeColor} nodeStrokeWidth={3} bgColor="rgba(18, 23, 32, 0.88)" zoomable pannable />
                <Controls />
                <Background bgColor="transparent" color="rgba(238, 241, 247, 0.16)" gap={28} size={1.1} variant={BackgroundVariant.Dots} />
